...
const ContestAndEventsFold = () => {
  ...
  return (
    <div className="pt-44" id="contestandevents">
      ...
      <div className="mt-10 px-8 md:px-16 mb-2 flex flex-col lg:flex-row justify-center gap-8 overflow-x-clip font-Brinnan">
        {contests.map(({ id, title, description, deadline, reward }) => (
          ...
          >
            ...
            <div className="text-centerfont-light md:font-normal text-sm text-white/80">
              {description}
            </div>
